...
from .modules.no_gate_rnn_model import NoGateRNNModel, BatteryEnv
...
# test code
class Calibration2(Policy):
    def __init__(self):
        super().__init__()
        battery = BatteryEnv(13, 5, 7.5)
        self.model = NoGateRNNModel.load_from_checkpoint(
            "bot/data/candidates/no_gate_rnn_model-preproc-patch-imp-10d-4l-no-beta-inc-epoch=09-with-val_loss=-112.917-val_loss_sec=-218.520.ckpt",
            battery=battery,
            map_location="cpu",
        )
