...
# actions
# 1: max charge - panel = 1.0, grid = 1.0
# 2: solar charge - panel = 1.0, grid = 0.0
# 3. max discharge - panel = 0.0, grid = -1.0
# 4. solar discharge - panel = 0.0, grid = 0.0
# 5. mild charge - panel = 0.5, grid = 0.0
# 6. medium charge - panel = 0.5, grid = 0.5
# 7. mild discharge - panel = 0.0, grid = -0.5
# TODO: WIP


class DiscreteStatelessModel(pl.LightningModule):
    def __init__(
        self,
